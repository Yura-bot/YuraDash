...
export default {
  install: (app, options) => {
    ...
    app.component('scroll-nav', require('@/components/bootstrap/ScrollSpy/scroll-nav').default)
    app.component('spynav-content', require('@/components/bootstrap/ScrollSpy/spynav-content').default)
    app.component('spynav-item', require('@/components/bootstrap/ScrollSpy/spynav-item').default)
  }
}
