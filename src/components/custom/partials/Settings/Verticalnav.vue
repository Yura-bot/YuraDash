    ...
    <ul class="navbar-nav iq-main-menu">
        <li class="nav-item static-item">
            <a class="nav-link static-item disabled" href="#" tabindex="-1">
                <span class="default-icon">{{ t('verticalnav.home') }}</span>
        ...
        <li class="nav-item">
            <router-link :class="`nav-link ${checkActive('default.dashboard') ? 'active' : ''}`" aria-current="page" :to="{name: 'default.dashboard'}">
                ...
                <span class="item-name">{{ t('verticalnav.dash') }}</span>
            </router-link>
        </li>
        <li class="nav-item">
            <router-link :class="`nav-link ${checkActive('default.UserProfile') ? 'active' : ''}`" :to="{name: 'default.UserProfile'}">
                ...
                <span class="item-name">{{ t('verticalnav.my_profil') }}</span>
            </router-link>
        </li>
        <li><hr class="hr-horizontal"></li>
        <li class="nav-item static-item">
            <a class="nav-link static-item disabled" href="#" tabindex="-1">
                <span class="default-icon">{{ t('verticalnav_settings.settings') }}</span>
                <span class="mini-icon">-</span>
            </a>
        </li>
        <li class="nav-item">
            <router-link :class="`nav-link ${checkActive('guild.guild') ? 'active' : ''}`" aria-current="page" :to="'/guild/'+ guildId">
                <i class="icon">
                    <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span class="item-name">{{ t('verticalnav_settings.config') }}</span>
            </router-link>
        </li>
        <li class="nav-item">
            <router-link :class="`nav-link ${checkActive('guild.bvn') ? 'active' : ''}`" aria-current="page" :to="'/guild/bvn/'+ guildId">
                <i class="icon">
                    <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span class="item-name">{{ t('verticalnav_settings.welcome') }}</span>
            </router-link>
        </li>
        <li class="nav-item">
            <router-link :class="`nav-link ${checkActive('guild.goodbye') ? 'active' : ''}`" aria-current="page" :to="'/guild/goodbye/'+ guildId">
                <i class="icon">
                    <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span class="item-name">{{ t('verticalnav_settings.goodbye') }}</span>
            </router-link>
        </li>
        <li class="nav-item">
            <router-link :class="`nav-link ${checkActive('guild.autorole') ? 'active' : ''}`" aria-current="page" :to="'/guild/autorole/'+ guildId">
                <i class="icon">
                    <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span class="item-name">{{ t('verticalnav_settings.autorole') }}</span>
            </router-link>
        </li>
        <li class="nav-item">
            <router-link :class="`nav-link ${checkActive('guild.auto-mod') ? 'active' : ''}`" aria-current="page" :to="'/guild/auto-mod/'+ guildId">
                <i class="icon">
                    <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span class="item-name">{{ t('verticalnav_settings.auto_mod') }}</span>
            </router-link>
        </li>
        <li><hr class="hr-horizontal"></li>
        <li class="nav-item static-item">
            <a class="nav-link static-item disabled" href="#" tabindex="-1">
                <span class="default-icon">{{ t('verticalnav_settings.extensions') }}</span>
                <span class="mini-icon">-</span>
            </a>
        </li>
        <li class="nav-item">
            <router-link :class="`nav-link ${checkActive('guild.ticket') ? 'active' : ''}`" aria-current="page" :to="'/guild/ticket/'+ guildId">
                <i class="icon">
                    <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span class="item-name">{{ t('verticalnav_settings.ticket') }}</span>
            </router-link>
        </li>
        <li class="nav-item">
            <router-link :class="`nav-link ${checkActive('guild.react-roles') ? 'active' : ''}`" aria-current="page" :to="'/guild/react-roles/'+ guildId">
                <i class="icon">
                    <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span class="item-name">{{ t('verticalnav_settings.react_roles') }}</span>
            </router-link>
        </li>
    </ul>
</template>
