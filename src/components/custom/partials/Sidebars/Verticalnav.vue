<template>
    <ul class="navbar-nav iq-main-menu">
        ...
        <li class="nav-item static-item">
            <a class="nav-link static-item disabled" href="#" tabindex="-1">
                <span class="default-icon">{{ t('verticalnav.links') }}</span>
                <span class="mini-icon">-</span>
            </a>
        </li>
        <li class="nav-item">
            <router-link class="nav-link" aria-current="page" to="/discord">
                <i class="icon">
                    <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span class="item-name">{{ t('verticalnav.discord') }}</span>
            </router-link>
        </li>
        <li class="nav-item">
            <router-link class="nav-link" aria-current="page" to="/webiste">
                <i class="icon">
                    <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span class="item-name">{{ t('verticalnav.website') }}</span>
            </router-link>
        </li>
        <li class="nav-item">
            <router-link class="nav-link" aria-current="page" to="/status">
                <i class="icon">
                    <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span class="item-name">{{ t('verticalnav.status') }}</span>
            </router-link>
        </li>
        <li><hr class="hr-horizontal"></li>
        <li class="nav-item static-item">
            <a class="nav-link static-item disabled" href="#" tabindex="-1">
                <span class="default-icon">{{ t('verticalnav.other') }}</span>
                <span class="mini-icon">-</span>
            </a>
        </li>
        <li class="nav-item">
            <router-link class="nav-link" aria-current="page" to="/docs">
                <i class="icon">
                    <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span class="item-name">{{ t('verticalnav.doc') }}</span>
            </router-link>
        </li>
    </ul>
</template>
